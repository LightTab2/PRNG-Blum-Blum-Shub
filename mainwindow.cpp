...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    connect(ui->showCheck,      &QCheckBox::toggled,                this, [this](bool toggle)   { this->bText       = toggle; this->ui->resultsText ->setEnabled(toggle); this->ui->cypherBitText->setEnabled(toggle); this->ui->cypherText->setEnabled(toggle); this->ui->plainText->setEnabled(toggle);});
...
void MainWindow::visualize()
{
    ...
    bool        bCypher     = cypherBit.size(); //Wizualizacja w zależności od tego, czy szyfrujemy, czy generujemy ciąg, będziemy wizualizować inne dane ([cypherBit] lub [bitData])
    //Powstały ,,obrazek'' posiada wymiary w proporcjach 1:2
